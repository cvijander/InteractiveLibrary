...
namespace AnthonyRobbins.AwakenTheGiantWthin.Console
{
    public static class BookBase
    {
        ...
        public static Quote BendzaminDizraeli()
        {
            Quote quote = new Quote();            
        ...
        public static Quote AnthonyRobbins1()
        {
            Quote quote = new Quote();            
        ...
        public static Quote AnthonyRobbins2()
        {
            Quote quote = new Quote();            
        ...
        public static Quote AnthonyRobbins3()
        {
            Quote quote = new Quote();            
        ...
        public static Quote AnthonyRobbins4()
        {
            Quote quote = new Quote();            
        ...
        public static Quote AnthonyRobbins5()
        {
            Quote quote = new Quote();            
        ...
        public static Quote AnthonyRobbins6()
        {
            Quote quote = new Quote();            
        ...
        public static Quote AnthonyRobbins7()
        {
        ...
        public static Quote AnthonyRobbins8()
        {
            Quote quote = new Quote();            
