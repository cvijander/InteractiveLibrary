...
namespace AnthonyRobbins.AwakenTheGiantWthin.ConsoleApp.Technics
{
    public static class TechnicFactory
    {
        public static Technic HowToMakePermanentChange(Author author)
        {
            ...
            Step podkorakC = new Step("3. Ovladavanje aspektom veza", "Ovladavanje svojim vezama, - romanticnim, porodicnim, poslovnim i drustvenim. Treca lekcija ove knjige o ovladavanju otkrice vam tajne koje ce vas osposobiti da stvarate kvalitetne veze - PRVO SA SAMIM SOBOM, a zatim i sa drugima.\n\nPocete tako sto cete otkriti sta najvise cenite, kakva su vasa ocekivanja, pravila po kojima igrate igru zivota, kao i kako se sve to odnosi na druge igrace. \n\n Kada ovladate ovom znacajnom vestinom, naucicete kako da se povezete s ljudima na najvisem nivou i budete nagrajdeni necim sto svi zelimo da dozivimo:\n osecanjem da smo dali doprinos, saznanjem da smo napravili PROMENU u zivotima drugih ljudi. \n Ovladavanje ovom lekcijom pruzice vam neogranicene izvore razvoja i davanja doprinosa.");
            Step podkorakD = new Step("4. Ovladavanje aspektom finansija", "Cetvrta lekcija , o ovladavanju finansija, naucice vas kako da prevazidjete cilj pukog prezivljavanja u poznim godinama zivota, pa cak i sada, dok govorimo o tome.\nBuduci da imamo srece da zivimo u kapitalistickom drustvu, svako od nas ima mogucnost da ostvri svoje snove.\n Ipak , vecina nas konstantno dozivljava finansijski pritisak i mastamo da bi ga veca kolicina novca umanjila.\n Dozvolite mi da vas ubedim da  sto vise novca imate, verovatno cete osecati vec pritisak.\n\nKljuc nije u pukoj teznji za bogatstvom, vec u menjanju vasih uverenja i stavova o njemu,\n tako da ga gledate kao sredstvo za davanje doprinosa, a ne kao opravdanje i krajnji cilj za dostizanje srece.\nKako da promenite ono sto prouzrokuje oskudicu u vasem zivotu, a zatim i kako dosledno da dozivljavate vrednosti, uverenja i emocije koje su od sustinske vaznosti za ostvarivanje bogatstva i kako da ga zadrzite i povecavate.\nZatim cete definisiati svoje ciljeve i oblikovati svoje snove, pogledom uperenim ka dostizanju najveceg moguceg nivoa blagostanja koje ce vas ispuniti dusevnim mirom \n i osloboditi vas kako biste mogli sa uzbudjenjem da iscekujete sve mogucnosti koje vam zivot nudi. ");
